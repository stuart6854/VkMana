...
namespace VkMana::SamplesApp
{
    ...
    void StaticMesh::SetSubmeshes(const std::vector<Submesh>& submeshes) { m_submeshes = submeshes; }

    void StaticMesh::SetMaterials(const std::vector<MaterialHandle>& materials) { m_materials = materials; }
